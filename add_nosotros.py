...
for fpath in files:
    ...
    # skip auth pages which we just removed the ul from
    if '<ul class="navbar-nav' not in content:
        continue
        
    # extract filename safely handling both windows and linux slashes just in case
    ...
    # match the whole ul and replace
